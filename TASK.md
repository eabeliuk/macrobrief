...
- [ ] Wire WhatsApp live: `macrobrief-telnyx-key/-whatsapp-from/-wa-template` set 2026-09-22 (`daily_brief`); `-wa-auth-template` (Meta Authentication template `verification_code`, copy-code button) pending; redeploy, smoke-test
